...
function xarpages_user_display($args)
{
    ...
    $data = xarModAPIfunc('xarpages', 'user', 'addcurrentpageflags',
    ...
    $item['itemid'] = $pid;
    $item['returnurl'] = xarModURL('xarpages','user','display', array('pid' => $pid));
    ...
    return xarTplModule('xarpages', 'page', $data['inherited']['pagetype']['name'], $data,
